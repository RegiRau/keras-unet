...
def custom_adj_unet(input_size= (256, 256, 1), pretrained_weights = None, max_number_of_nodes = 80, ):
    #= (256, 256, 1)
    ...
    unet_out = Conv2D(64, 3, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(merge9)
    ...
    conv_gh1 = Conv2D(max_number_of_nodes, 3, activation='relu', padding='same', kernel_initializer='he_normal')(drop_gh1)
    pool_gh2 = MaxPooling2D(pool_size=(4, 4))(conv_gh1)

    drop_gh3  = Conv2D(1, 4, activation='relu', padding='same', kernel_initializer='he_normal')(pool_gh2)

    fullyconnected_node_postions = Flatten()(drop_gh3)
    unet_out_dimensions = unet_out.shape

    layer_np_1 = Dense(unet_out_dimensions[1], activation='relu')(fullyconnected_node_postions)
    ...
    conv_adj1  = Conv2D(125, 3, activation='relu', padding='same', kernel_initializer='he_normal')(conv_adj1)
